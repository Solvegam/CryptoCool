 ...
 * CommonJS
 */
function define(a,c,e){define.a[a]={e:c,d:e}}define.a={};define.b=function(a,c,e){for(var g=[],f=0;f<a.length;f++){var d=define.a[a[f]];if(!d)throw"All the modules must already be 'defined' Async load not supported: use a full-featured AMD loader like requirejs";d.c||define.b(d.e,d.d,a[f]);g.push(d.c)}a=c.apply(null,g);if(e)define.a[e].c=a};function oneRequire(a,c){define.b(a,c,null)};(function(){define("IllegalStateException",[],function(){function e(e){this.name="IllegalStateException";this.message=e}e.prototype={toString:function(){return["[",this.name,this.message,"]"].join("|")}};return e});
...
null!=l.di&&(d+="LS_adapter_set\x3d"+encodeURIComponent(l.di)+"\x26"),null!=l.jk&&(d+="LS_user\x3d"+encodeURIComponent(l.jk)+"\x26"),h="LS_op2\x3dcreate\x26"+a+"LS_cid\x3dtqGko0tg4pkpW3CAK3R4hwLri8LBNFi\x26"+d,A&&(h+="LS_old_session\x3d"+A+"\x26"),g.logDebug(e.resolve(6),h),null!=l.password&&(h+="LS_password\x3d"+encodeURIComponent(l.password)+"\x26"),h;b.verifyOk(d)||g.logError(e.resolve(4));l="LS_session\x3d"+d+"\x26"+a;g.logDebug(e.resolve(5),l);return l},Xv:function(a,b){var c={LS_op:"destroy",
...
null!=d&&(this.Yk=t.Ou(this,d),this.Yk.addListener(this.M)),this.id=this.nc.fa();else{this.nc=null;do this.id="NS"+p++;while(e.Ui(this.id,"lsEngine"))}e.ra(this.id,"lsEngine",this);this.g=new a(this,this.M);this.So(n,f.ro);this.ha.zg&&this.Al()}var p=n.randomG(),t="1718";isNaN(t)&&(t=0);var u=d.getLoggerProxy(f.Fd);q.prototype={toString:function(){return"[LightstreamerEngine "+this.id+"]"},So:function(a,b){b||(b="LOCAL"+p++);var c=new k(this,b);c.Sj(a);a.kA(c);this.M.Cr(b,c)},kd:function(){return this.id},
...
define('ls_sbc',["IllegalStateException"],function(e){return function(f){return{enableSharing:function(){throw new e("ConnectionSharing is not included in the Lightstreamer library");},isMaster:function(){return f.kf()}}}});
...
define("RemoteAppender",["Inheritance","BufferAppender","Executor","IllegalArgumentException","SimpleLogLevels"],function(e,f,d,c){function b(d,g,a){this._callSuperConstructor(b,[d,g,10]);this.waiting=!1;if(!a)throw new c("a LightstreamerClient instance is necessary for a RemoteAppender to work.");this.xo=a}b.prototype={log:function(c,d,a,e){this._callSuperMethod(b,"log",[c,d,a,e]);this.Ao(!0)},Ao:function(b){if(!(0>=this.getLength())){if(0==this.xo.Gb().indexOf("CONNECTED")){var c=this.ov();if(this.xo.uh(c)){this.reset();
this.waiting=!1;return}}this.waiting&&b||(this.waiting=!0,d.addTimedTask(this.Ao,2E3,this))}},ov:function(c,d){var a=this._callSuperMethod(b,"extractLog",["LS_log"]),a=a.split("LS_log");d="LS_log";for(var e={},f=0;f<a.length;f++)0!=a[f].length&&(e[d+(f+1)]=encodeURIComponent(a[f].replace(/[\n\r\f]/g,"||")));return e},extractLog:function(){return null}};b.prototype.extractLog=b.prototype.extractLog;b.prototype.log=b.prototype.log;e(b,f,!1,!0);return b});
